...
* Again sets version nibble and reserved bits in random UUID generation per RFC 4122, leaving 122 bits for random data. This restores behavior present in version 0.1.0.
